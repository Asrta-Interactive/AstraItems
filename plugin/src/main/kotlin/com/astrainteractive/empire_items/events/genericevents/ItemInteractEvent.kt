...
class ItemInteractEvent {
    ...
    val quitEvent = DSLEvent.event<PlayerQuitEvent> { e ->
    ...
    val onClick = DSLEvent.event<PlayerInteractEvent> { e ->
    ...
    val onDrink = DSLEvent.event<PlayerItemConsumeEvent> { e ->
    ...
    val onFurnaceEnded = DSLEvent.event<FurnaceSmeltEvent> { e ->
    ...
    val onEntityDamage = DSLEvent.event<EntityDamageEvent> { e ->
    ...
    val onPlayerQuit = DSLEvent.event<PlayerQuitEvent> { e ->
        cooldown.remove(e.player.name)
    }
}