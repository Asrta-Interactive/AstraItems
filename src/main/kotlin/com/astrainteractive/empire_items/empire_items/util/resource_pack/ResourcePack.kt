...
class ResourcePack {
    ...
    private fun generateItems() {
        ...
        ItemApi.getSimpleItems().forEach { item ->
    ...
    init {
        ...
        saveFileFromResources("pack/base/block/original/brown_mushroom_block_true.json",path + sep + "brown_mushroom_block_true.json")
        saveFileFromResources("pack/base/block/original/mushroom_stem_true.json",path + sep + "mushroom_stem_true.json")
        saveFileFromResources("pack/base/block/original/red_mushroom_block_true.json",path + sep + "red_mushroom_block_true.json")
        //shaders
        path="$minecraftPath${sep}shaders${sep}core"
        recreateDirectory(path)
        saveFileFromResources("pack/base/shaders/core/rendertype_armor_cutout_no_cull.json",path + sep + "rendertype_armor_cutout_no_cull.json")
        saveFileFromResources("pack/base/shaders/core/rendertype_armor_cutout_no_cull.fsh",path + sep + "rendertype_armor_cutout_no_cull.fsh")
        saveFileFromResources("pack/base/shaders/core/rendertype_armor_cutout_no_cull.vsh",path + sep + "rendertype_armor_cutout_no_cull.vsh")
        //texts
