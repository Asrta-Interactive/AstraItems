...
class ItemUpgradeEvent : IAstraListener {
    ...
    private fun setAttrLore(itemMeta: ItemMeta, attr: String, amount: Double?): MutableList<String> {
        ...
        lore.add(AstraUtils.HEXPattern("${EmpirePlugin.translations.ITEM_UPGRADE_NAME_COLOR}${attrMap[attr] ?: attr}: ${EmpirePlugin.translations.ITEM_UPGRADE_AMOUNT_COLOR}${amount ?: "&kAAA"}"))
