package com.astrainteractive.empireprojekt.empire_items.util.crafting
...
import com.astrainteractive.empireprojekt.empire_items.util.crafting.data.EmpireCraftingTableRecipe
import com.astrainteractive.empireprojekt.empire_items.util.crafting.data.EmpireFurnaceRecipe
import com.astrainteractive.empireprojekt.empire_items.util.crafting.data.EmpireShapelessRecipe
...
class CraftingManager {
    ...
    fun createCraftingTableRecipes() {
        ...
        for (id in section.getKeys(false)) {
            ...
            val recipe =
                AstraYamlParser.fromYAML<EmpireCraftingTableRecipe>(obj, EmpireCraftingTableRecipe::class.java)
                    ?: continue
    ...
    fun createFurnaceRecipes() {
        ...
        for (id in section.getKeys(false)) {
            val obj = section.getConfigurationSection(id)
            val recipe =
                AstraYamlParser.fromYAML<EmpireFurnaceRecipe>(obj, EmpireFurnaceRecipe::class.java) ?: continue
            if (recipe.result == null)
                recipe.result = id
    ...
    fun createShapelessRecipe() {
        ...
        for (id in section.getKeys(false)) {
            val obj = section.getConfigurationSection(id)
            val recipe =
                AstraYamlParser.fromYAML<EmpireShapelessRecipe>(obj, EmpireShapelessRecipe::class.java) ?: continue
            if (recipe.result == null)
                recipe.result = id
