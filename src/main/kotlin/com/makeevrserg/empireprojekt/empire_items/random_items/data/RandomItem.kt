...
data class RandomItem(
    ...
    private fun getDisplayName(): String {
        ...
        return EmpireUtils.HEXPattern(displayNames[Random.nextInt(displayNames.size)])
    }
    ...
    private fun getLore(): List<String> {
        ...
        val lore = EmpireUtils.HEXPattern(lores[Random.nextInt(lores.size)])
    ...
    companion object {
        fun new() =
            EmpireYamlParser.fromYAML<List<RandomItem>>(
