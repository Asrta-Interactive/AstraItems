...
class EmpireSoundsMenu(playerMenuUtility: PlayerMenuUtility?) :
    ...
    override var slotsAmount: Int = EmpirePlugin.empireSounds.getSounds().keys.size
    ...
    override fun handleMenu(e: InventoryClickEvent) {
        ...
        if ((e.slot != 45) && (e.slot != 49) && (e.slot != 53)) {
            playerMenuUtility.player.playSound(playerMenuUtility.player.location,namespace+":"+sounds.elementAt(maxItemsPerPage*page+e.slot),1.0f,1.0f)
        }
