...
//    companion object{
//        fun new(section:ConfigurationSection):Command?{
//            val command = section.getString("command")?:return null
//            val asConsole = section.getBoolean("as_console",false)
//            return Command(command = command, asConsole = asConsole)
//        }
//        fun newList(section: ConfigurationSection?):List<Command>{
//            val list = mutableListOf<Command>()
//            section?:return list
//            for (key in section.getKeys(false))
//                list.add(new(section.getConfigurationSection(key)!!)?:continue)
//            return list
//        }
//    }
//}
